...
typedef struct  {        /*  This TYPE is the Fiber node sub-data structure  */
	...
	int	f_min_conduct_time[TABLE_LEN];
					/* minimum conduction time to target */
...
typedef struct  {        /*  This TYPE is the Cell node sub-data structure   */
	...
	int	c_min_conduct_time[TABLE_LEN];
					/* minimum conduction time to target */
...
typedef union	{
  GLOBAL_NETWORK_2	global_node;	/* global-type node          */
  C_NODE_2	cell_node;	/* cell-type node                    */
  F_NODE_2	fiber_node;	/* fiber-type node                   */
  S_NODE_2	synapse_node;	/* synapse parameter node            */
}  U_NODE_2;
